...
GLOBAL_QUERY = {
    ...
    'SELECT_LOGIN': [
        'SELECT ID, SENHA, NOME FROM PROFESSOR WHERE USUARIO=?;',
        'SELECT ID, SENHA, NOME FROM PROFESSOR WHERE USUARIO=%s;'
    ],
    'INSERT_PROF': [
        'INSERT INTO PROFESSOR(NOME, USUARIO, SENHA) VALUES(?, ?, ?);',
        'INSERT INTO PROFESSOR(NOME, USUARIO, SENHA) VALUES(%s, %s, %s);'
    ],
    'SELECT_QUESTAO_ID': [
